      ...
      <section class = "container">
        <div class = "row align-items-center justify-content-center my-5 py-5">
               <div class = "col-lg-4 mb-3">
                  <div class = "card">
                    <img class = "card-img-top" src="addproperty.jpg" alt = "">
                    <div class = "card-body">
                        ...
                        <!-- <div> -->
                          <a href="addProperty.jsp" class = "btn btn-outline-success btn-md"><i class="fas fa-plus"></i> Add Property</a>
                        <!-- </div> -->
                    </div>
                  </div>
               </div>
               <div class = "col-lg-4 mb-3">
                  <div class = "card">
                    <img class = "card-img-top" src="lease.jpg" alt = "">
                    <div class = "card-body">
